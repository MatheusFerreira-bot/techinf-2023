...
public class Exe01082005 {
    
    public static void main(String[] args) {
        
        String MatNome[][] = new String[3][3];
        String MatStatus[][] = new String[MatNome.length][MatNome.length];
        float MatNota1[][] = new float[MatNome.length][MatNome.length];
        float MatNota2[][] = new float[MatNome.length][MatNome.length];
        float MatMedia[][] = new float[MatNome.length][MatNome.length];
